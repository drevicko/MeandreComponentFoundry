...
public class Formatters {
	...
	static private final NumberFormat COMMA_FORMATTER = NumberFormat
			.getInstance();
	...
	static private final NumberFormat FLOAT_FORMATTER = NumberFormat
			.getInstance();
	 ...
	 * 
	 * <p>
	 * The formatted number always has a minimum of one digit before the decimal
	 * point, and a fixed specified number of digits after the decimal point.
	 * 
	 * @param x
	 *            The number.
	 * 
