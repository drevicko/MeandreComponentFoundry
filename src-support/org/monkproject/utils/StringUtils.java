...
public class StringUtils {
	...
	public final static String[] asciiControlCharacterNames = { "<NUL>",
	 ...
	 *            The string.
	 * @param start
	 *            Starting offset in string.
	 * @param lChar
	 *            Left delimiter.
	 * @param rChar
	 *            Right delimiter to match left delimiter.
	 * 
	 * @return The ending offset of the matching balanced string. -1 if not
	 *         found.
	 */
	...
	public static int countOccurrences(String source, String searchString) {
		...
		for (int i = 0; i < (source.length() - searchLength); i++) {
			if (source.regionMatches(i, searchString, 0, searchLength))
				result++;
		}
	 ...
	 *            The string.
	 * 
	 * @return Input string with control characters mapped to <name> form, e.g.,
	 *         <CR> for ascii 13.
	 */
	 ...
	 *            The field value.
	 * 
	 * @return "name = value". If the value has multiple lines the extra lines
	 *         are displayed indented so that they line up with the fist line.
	 */
	 ...
	 * 
	 * @param ch
	 *            The character to be duplicated.
	 * @param n
	 ...
	 *            String 2.
	 * 
	 * @return < 0 if string 1 < string 2, 0 if string 1 = string 2, > 0 if
	 *         string 1 > string 2.
	 */
	 ...
	 *            Date 2.
	 * 
	 * @return < 0 if date 1 < date 2, 0 if date 1 = date 2, > 0 if date 1 >
	 *         date 2.
	 */
	 ...
	 * 
	 * @param str2
	 *            The substring to search for, converted to lower case.
	 * 
	 * @param fromIndex
	...
	public static int indexOfIgnoreCaseWholeWord(String str1, String str2,
			int fromIndex) {
		if (str1 == null)
			return -1;
		if (str2 == null)
	...
	/**
	 * Returns true if a string contains another case-insensitive string as a
	 * whole word.
	 * 
	 * @param str1
	 *            The string to be searched.
	 ...
	 * 
	 * @return True if str1 contains str2 as a case-insensitive whole word.
	 */
	 ...
	 * 
	 *         <p>
	 *         The first token is defined to end at a space, a tab, a carriage
	 ...
	 * 
	 * @return The input string if not null, other an empty string.
	 */
	 ...
	 * 
	 * @return The string representation. This looks like [a, b, c ... ] for an
	 *         array. If the object is not an array, its toString() method is
	 *         used instead. Null objects are returned as "<null>".
	 * 
	 *         <p>
	 *         The regular java toString() routine for arrays is brain-dead: it
	 *         returns the hashcode/address of the array rather than a useful
	 *         representation of the array contents.
	 *         </p>
	 * 
	 */
	 ...
	 * 
	 * @return The integer converted to a string with enough leading zeros to
	 ...
	 *            Width of result field.
	 * 
	 * @return The long converted to a string with enough leading zeros to fill
	 ...
	 *            The width to pad to.
	 * 
	 * @return "s" padded with enough blanks on left to be "width" columns wide.
	 */
	 ...
	 *            The width to pad to.
	 * 
	 * @return "s" padded with enough blanks on right to be "width" columns
	 *         wide.
	 */
	 ...
	 * 
	 * @return The substring starting at the first character and extending up
	 *         the minimum of the string length or n. An empty string returned
	 ...
	 *            Maximum number of characters to extract.
	 * 
	 * @return The substring starting at the minimum of the first character or
	 *         the last character - n in the string and extending up the end of
	 *         the string. An empty string returned if the input string is null.
	 */
	 ...
	 * 
	 *         <p>
	 *         This method wraps long lines based on the supplied wrapColumn
	 *         parameter. Note: Remove or expand tabs before calling this
	 *         method.
	 *         </p>
	 */
	 ...
	 *            The string.
	 * 
	 * @return The trimmed string. Leading and trailing white space characters
	 *         are removed. If s is null, null is returned.
	 */
	 ...
	 * 
	 * @param s1
	 *            First string containing text lines.
	 * @param s2
	 *            Second string containing text lines.
	 * @param s1Prefix
	 *            Prefix for first string lines.
	 * @param s1Suffix
	 *            Suffix for first string lines.
	 * @param s2Prefix
	 *            Prefix for second string lines.
	 * @param s2Suffix
	 *            Suffix for second string lines.
	 * 
	 * @return String with lines from s1 and s2 interspersed.
	 */

	public static String intersperseTextLines(String s1, String s2,
			String s1Prefix, String s1Suffix, String s2Prefix, String s2Suffix) {
	 ...
	 * 
	 * @param s
	 *            The string containing characters to strip.
	 * @param charsToStrip
	 ...
	 * 
	 * @return String with unparenthesized text removed. Left parentheses are
	 *         also removed, and right parentheses replaced by a blank.
	 * 
	 *         <p>
	 *         Example:
	 *         <p>
	 ...
	 * 
	 * @param s
	 *            The string in which to compress multiple occurrences.
	 * @param c
	 ...
	 * 
	 *         <p>
	 *         A string is assumed to be a regular expression if it contains any
	 *         of the followint characters:
	 *         </p>
	 * 
	 *         <pre>
	 * * + - [ ] . &circ; &amp; \ $ ? { } ? =
