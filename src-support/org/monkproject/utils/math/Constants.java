...
public class Constants {
	 ...
	 * 
	 * @return The machine epsilon as a double. The machine epsilon MACHEPS is
	 *         the smallest number such that (1 + MACHEPS) == 1 .
	 */
	 ...
	 * 
	 * @return Maximum number of digits of precision for double precision
	 *         floating point.
	 */
