...
public class NumberOps {
	 ...
	 *            Second number.
	 * 
	 * @return -1 if number1 < number2 0 if number1 == number2 1 if number1 >
	 *         number2
	 */
	 ...
	 * 
	 * @return -1 if number < 0 0 if number1 == 0 1 if number1 > 0
	 */
	 ...
	 *         Integer. Any other combination of Number types results in a
	 *         Double.
	 *         </p>
	 */
	...
	public static Number add(Number number1, Number number2) {
		if ((number1 instanceof Integer) && (number2 instanceof Integer)) {
			return new Integer(((Integer) number1).intValue()
	 ...
	 *         If both number1 and number2 are Integers, the result is an
	 *         Integer. Any other combination of Number types results in a
	 *         Double. Zerodivides are passed through as NAN.
	 *         </p>
	 */
	 ...
	 * 
	 *         <p>
	 *         The numbers are converted to Longs before performing the
	 *         operation. The result is a Long. This gives the expected results
	 *         if the numbers are both integral.
	 *         </p>
	 */
	 ...
	 *             if "s" does not contain a valid number.
	 * 
	 *             <p>
	 *             If the string contains an integer, the resulting Number is an
	 *             Integer. Anything other valid numeric string is converted to
	 *             a Double. An invalid numeric string throws a
	 *             NumberFormatException.
	 *             </p>
	 */

	public static Number toNumber(String s) throws NumberFormatException {
		Number result;
