...
public class Polynomial {
	 ...
	 * 
	 * @param polycoefs
	 *            Array of polynomial coefficients. The coefficients should be
	 *            ordered with the constant term first and the coefficient for
	 *            the highest powered term last.
	 * 
	 * @param x
	 ...
	 *         c[i]*x^i + ... + c[1]*x + c[0] = c[0] + x*(c[i-1]*x^[i-1] + ... +
	 *         c[1])
	 *         </p>
	 * 
	 *         <p>
	 *         Horner's method avoids loss of precision which can occur when the
	 *         higher-power values of x are computed directly.
	 *         </p>
	 */
	 ...
	 * 
	 * @param coeffs
	 *            The Chebyschev polynomial coefficients.
	 * 
	 * @param x
