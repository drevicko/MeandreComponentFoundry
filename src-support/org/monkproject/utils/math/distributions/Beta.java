...
public class Beta {
	 ...
	 * 
	 *         <p>
	 *         The log of the beta distribution is calculated from the log of
	 *         the gamma distribution using the following relationship:
	 *         </p>
	 * 
	 *         </p> logBeta(a,b) = logGamma(a) + logGamma(b) - logGamma( a + b )
	 *         </p>
	 */
	 ...
	 * 
	 *         <p>
	 *         The beta distribution value is calculated from the gamma
	 *         distribution using the following relationship:
	 *         </p>
	 * 
	 *         </p> Beta(a,b) = ( Gamma(a) * Gamma(b) ) / Gamma( a + b ) </p>
	 */
	 ...
	 * 
	 * @param x
	 *            Upper percentage point of incomplete beta probability density
	 *            function
	 * @param alpha
	 ...
	 * 
	 *             <p>
	 *             The continued fraction expansion as given by Abramowitz and
	 *             Stegun (1964) is used. This method works well unless the
	 *             minimum of (alpha, beta) exceeds about 70000. For most common
	 *             values the result will be accurate to about 14 decimal
	 *             digits.
	 *             </p>
	 */

	public static double incompleteBeta(double x, double alpha, double beta,
			int dPrec) throws IllegalArgumentException {
		double epsz;
		double a;
		double b;
		double c;
		...
		if ((x == a) || (x == b)) {
			...
			c = Gamma.logGamma(a + b) + a * Math.log(x) + b * Math.log(1.0 - x)
		...
		ahi = Math.exp(Gamma.logGamma(apb) + a * Math.log(x) + b
				* Math.log(1.0D - x) - Gamma.logGamma(a + 1.0D)
				- Gamma.logGamma(b));
	...
	public static double incompleteBetaInverse(final double p,
		...
		MonadicFunction function = new MonadicFunction() {
