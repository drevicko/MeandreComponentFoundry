...
public class Gamma {
	 ...
	 * 
	 * @param x
	 *            Value for which Gamma is to be computed.
	 * 
	 ...
	 *         <strong>Lecture Notes in Mathematics</strong>, 506, Numerical
	 *         Analysis Dundee, 1975, G. A. Watson (ed.), Springer Verlag,
	 *         Berlin, 1976.
	 *         </p>
	 * 
	 *         <p>
	 *         Also see Hart et al, "Computer Approximations", Wiley(1968), p.
	 *         130F.
	 *         </p>
	 * 
	 *         <p>
	 *         This java code is a fairly straightforward translation of the
	 *         freely available Fortran function GAMMA by Cody and Stolz.
	 *         </p>
	 */

	public static double gamma(double x) {
		final double[] p = { -1.71618513886549492533811D,
				24.7656508055759199108314D, -379.804256470945635097577D,
				629.331155312818442661052D, 866.966202790413211295064D,
				-31451.2729688483675254357D, -36144.4134186911729807069D,
				66456.1438202405440627855D };

		final double[] q = { -30.8402300119738975254353D,
				315.350626979604161529144D, -1015.15636749021914166146D,
				-3107.77167157231109440444D, 22538.1184209801510330112D,
				4755.84627752788110767815D, -134659.959864969306392456D,
				-115132.259675553483497211D };

		final double[] c = { -0.001910444077728D, 8.4171387781295e-4,
				-5.952379913043012e-4, 7.93650793500350248e-4,
				-0.002777777777777681622553D, 0.08333333333333333331554247D,
				0.0057083835261D };
	 ...
	 *         Double.POSITIVE_INFINITY is returned for y <= 0.0 or when
	 *         overflow would occur.
	 * 
	 *         <p>
	 ...
	 * 
	 *         <p>
	 *         See Hart et al, "Computer Approximations", Wiley(1968), p. 130F,
	 *         and also Cody and Hillstrom, "Chebyshev approximations for the
	 *         natural logarithm of the Gamma function", Mathematics of
	 *         Computation, 21, April, 1967, P. 198F.
	 *         </p>
	 * 
	 *         <p>
	 *         The minimax coefficients for y > 12 come from Hart et al. The
	 *         other coefficients come from unpublished work by W. J. Cody and
	 *         L. Stoltz at Argonne National Laboratory. This java code is a
	 *         fairly straightforward translation of the freely available
	 *         Fortran function ALGAMA by Cody and Stolz.
	 *         </p>
	 */
	 ...
	 *            Shape parameter
	 * @param dPrec
	 *            Digits of precision desired (1 < dPrec < Constants.MAXPREC)
	 * @param maxIter
	 ...
	 *             approximation is used, depending upon the argument range. See
	...
	public static double incompleteGamma(double x, double alpha, int dPrec,
			int maxIter) throws IllegalArgumentException {
