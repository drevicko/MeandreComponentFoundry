 ...
 * 
 * <p>
 * This class provides "one stop shopping" for point probabilities percentage
 * points for commonly used statistical distributions. These include the Beta,
 * F, t, chi-square, and normal distributions. Both the forward (probability)
 * and inverse (percentage point) functions are provided. This class is actually
 * just provides a shim to the methods in the individual classes for each
 * distribution.
 * </p>
 * 
 * <p>
...
public class Sig {
	...
	public static double sidak(double p, int n) {
		...
		if (n > 1)
			result = 1.0D - Math.pow(1.0D - p, (1.0D / n));
