...
public class Studentst {
	 ...
	 * 
	 * @param t
	 *            Percentage point of Student t distribution
	 * 
	 * @param df
	 *            Degrees of freedom
	 * 
	 ...
	 * 
	 *             <p>
	 *             The probability is computed using the following relationship
	 *             between the incomplete beta distribution and Student's t:
	 *             </p>
	 * 
	 *             <p>
	...
	public static double t(double t, double df) throws IllegalArgumentException {
		...
		if (df > 0.0D) {
			result = Beta.incompleteBeta(df / (df + t * t), df / 2.0D, 0.5D,
					Constants.MAXPREC);
		} else {
	 ...
	 * 
	 * @param p
	 *            Probability level for percentage point
	 * @param df
	 *            Degrees of freedom
	 * 
	 ...
	 * 
	 *             <p>
	 *             The percentage point is computed using the inverse incomplete
	 *             beta distribution. This allows for fractional degrees of
	 *             freedom.
	 *             </p>
	 */
