...
public class BracketRoot {
	 ...
	 * 
	 * @param bracket
	 *            Array containing initial estimate for of bracketing interval.
	 * 
	 *            bracket[0] is left hand estimate. bracket[1] is right hand
	 *            estimate.
	 * 
	 * @param function
	 ...
	 * 
	 * @param maxIter
	 *            Maximum number of iterations to try expanding bracket.
	 * 
	 * @param expansionFactor
	 *            Factor by which to expand bracket interval on each iteration.
	 * 
	 * @return True if bracket successfully found The new bracket will be placed
	 *         in "bracket".
	 * 
	 *         False if bracket could not be found within maxIter attempts.
	 */

	public static boolean bracketRoot(double bracket[],
			MonadicFunction function, int maxIter, double expansionFactor) {
