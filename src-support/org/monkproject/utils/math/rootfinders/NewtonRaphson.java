 ...
 * initial estimate x0 for a root and that the function be continuous and
 * everywhere differentiable.
 * </p>
 * 
 * <p>
 * If the derivative of the function whose root is being sought is difficult or
 * expensive to compute, the Method of Secants or Brent's Method is a better
 * choice. If the function is not everywhere differentiable, Bisection is the
 * method to use.
 * </p>
 */
...
public class NewtonRaphson implements MonadicFunctionRootFinder {
	 ...
	 *             if function or derivativeFunction is null.
	 */
	...
	public static double newtonRaphson(double x0, double tol, int maxIter,
			MonadicFunction function, MonadicFunction derivativeFunction)
			throws IllegalArgumentException {
		return newtonRaphson(x0, tol, maxIter, function, derivativeFunction,
	 ...
	 * 
	 *             <p>
	 *             Up to 100 iterations are attempted with the convergence
	 *             tolerance set to Constants.MACHEPS .
	 *             </p>
	 */

	public static double newtonRaphson(double x0, MonadicFunction function,
			MonadicFunction derivativeFunction) throws IllegalArgumentException {
		return newtonRaphson(x0, Constants.MACHEPS, 100, function,
				derivativeFunction, new StandardRootFinderConvergenceTest(),
				null);
	}
