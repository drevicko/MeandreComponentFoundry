...
public class StandardRootFinderConvergenceTest implements
	 ...
	 * 
	 * <p> This standard convergence test indicates convergence when
	 * |xNow-xPrev| <= xTolerance, or |fxNow| <= fxTolerance. </p>
	 */

	public boolean converged(double xNow, double xPrev, double fxNow,
			double xTolerance, double fxTolerance) {
		return (Math.abs(xNow - xPrev) <= xTolerance)
